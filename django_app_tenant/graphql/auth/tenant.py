...
from django_app_core.decorators import google_captcha3, strip_input
from django_app_core.utils import is_valid_email, is_valid_password
from django_app_tenant.graphql.auth.types.tenant import (
    RegisterTenantResponseType,
    TenantNode,
)
from django_app_tenant.models import Domain, Tenant
from django_app_tenant.services.tenant_service import TenantService
                ...
                if result:
                    if DJANGO_APP_ORGANIZATION_INSTALLED:
                        ...
                        (
                            ...
                            organization,
                            user,
                        ) = organization_service.initiate_schema(
